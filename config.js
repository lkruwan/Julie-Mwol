...
module.exports = {
    ...
    MENTION: process.env.TAG_REPLY === undefined ? '94769370897@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'Lusifar' : process.env.BOT_NAME,
    ...
    YAK: process.env.YAK === undefined ? '94769370897,0' : process.env.YAK,
    BRANCH: 'master',
    HEROKU: {
